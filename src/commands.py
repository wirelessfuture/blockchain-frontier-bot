...
# Import parsers
from parsers import market_data_parser, eth_gas_price_parser

# Import the coingecko functions
from coingecko import get_trending_search, get_market_data, get_gigachad_prices

# Import the defipulse functions
from defipulse import get_eth_gas_prices, get_defi_pulse_data
...
def on_message(func: any) -> any:
    ...
    whitelisted_group = [
        int(os.getenv("TELEGRAM_GROUP_CHAT_ID")),
        int(os.getenv("TELEGRAM_BOT_CHAT_ID")),
        int(os.getenv("WIVERS_CHAT_ID")),
    ]  # Hard-coded for now
